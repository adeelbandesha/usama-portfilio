			...
			<div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
				...
				<div class="p-2 sm:w-1/2 w-full">
					<div class="bg-gray-800 rounded flex p-4 h-full items-center">
						...
						<span class="title-font font-medium text-white">Bug Fixes</span>
					</div>
				</div>
			</div>
			<div class="flex justify-evenly">
				<a href="https://www.fiverr.com/users/usama_yar?up_rollout=true">
					<button
				...
				<a href="https://www.upwork.com/freelancers/~0152fc0e67d435f99c">
					<button
						class="flex mx-auto mt-16 text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg"
					>
						Upwork
